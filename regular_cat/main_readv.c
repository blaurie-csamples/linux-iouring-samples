// sample of readv function and use
...
/*
 * Returns the size of the file whos open file descriptor is passed in
...
int read_and_print_file(char *file_name) {
    ...
    while (bytes_remaining) {
        ...
        //posix_memalign address of memory it allocated will be a multiple of *alignment*
        void *buf;
     ...
     * from iovecs and print them to the console
     */
